...
dnf install htop nvtop neofetch mlocate entr time vifm pass jq bat bmon nethogs xsel unrar p7zip lm_sensors fzf ripgrep glances asciinema exa ncdu xbindkeys xdotool
